<?php
include 'get_action_page.php';
include 'post_action_page.php';

//echo "Start php_example.php\n";
$str1 = 'This is a demo 4 of PHP used to write a simple HTML webpage';
...
$output = $output . "<form action='/Users/aa77686/Documents/GitHub/phpprojects/get_action_page.php' method='get'>";
...
$output = $output . "<form action='/Users/aa77686/Documents/GitHub/phpprojects/post_action_page.php' method='post'>";
